...
* ⚠️ **WARN** <p>The most common width is 685 among a set of 11 math glyphs.
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, math, hebrew, malayalam, tai-le, duployan, old-permic, tifinagh, syriac, todhri, coptic</li>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Ekpeye (Latn, 226,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mundani (Latn, 34,000 speakers), Basaa (Latn, 332,940 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Zapotec (Latn, 490,000 speakers), Dan (Latn, 1,099,244 speakers), Yala (Latn, 200,000 speakers), Igbo (Latn, 27,823,640 speakers), Lugbara (Latn, 2,200,000 speakers), Kom (Latn, 360,685 speakers), Mfumte (Latn, 79,000 speakers), Mango (Latn, 77,000 speakers), Ebira (Latn, 2,200,000 speakers), Vute (Latn, 21,000 speakers), Koonzime (Latn, 40,000 speakers), Nateni (Latn, 100,000 speakers), Kaska (Latn, 125 speakers), South Central Banda (Latn, 244,000 speakers), Gulay (Latn, 250,478 speakers), Sar (Latn, 500,000 speakers), Avokaya (Latn, 100,000 speakers), Teke-Ebo (Latn, 260,000 speakers), Makaa (Latn, 221,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Navajo (Latn, 166,319 speakers), Han (Latn, 6 speakers), Southern Kisi (Latn, 360,000 speakers), Bafut (Latn, 158,146 speakers), Dii (Latn, 71,000 speakers), Ejagham (Latn, 120,000 speakers), Cicipu (Latn, 44,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Fur (Latn, 1,230,163 speakers), Ma’di (Latn, 584,000 speakers), Aghem (Latn, 38,843 speakers), Bete-Bendi (Latn, 100,000 speakers), Nzakara (Latn, 50,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Heiltsuk (Latn, 300 speakers).</p>
 [code: soft-dotted]
...
<details><summary>[15] Parkinsans-Semibold.ttf</summary>
<div>
<details>
...
* ⚠️ **WARN** <p>The most common width is 666 among a set of 11 math glyphs.
The following math glyphs have a different width, though:</p>
<p>Width = 567:
greater</p>
<p>Width = 670:
...
<details><summary>[13] Parkinsans-Medium.ttf</summary>
<div>
<details>
    <summary>⚠️ <b>WARN</b> Does GPOS table have kerning information? This check skips monospaced fonts as defined by post.isFixedPitch value <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/opentype.gpos.html#"></a></summary>
    <div>
...
* ⚠️ **WARN** <p>The most common width is 650 among a set of 11 math glyphs.
The following math glyphs have a different width, though:</p>
<p>Width = 590:
greater</p>
<p>Width = 699:
...
* ⚠️ **WARN** <p>The most common width is 624 among a set of 11 math glyphs.
The following math glyphs have a different width, though:</p>
<p>Width = 539:
greater</p>
<p>Width = 643:
...
<details><summary>[14] Parkinsans-Extrabold.ttf</summary>
<div>
<details>
    <summary>🔥 <b>FAIL</b> Check font names are correct <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/googlefonts.name.html#"></a></summary>
    <div>
...
* ⚠️ **WARN** <p>The most common width is 700 among a set of 11 math glyphs.
The following math glyphs have a different width, though:</p>
<p>Width = 519:
greater</p>
<p>Width = 609:
...
<details><summary>[11] Parkinsans-Light.ttf</summary>
<div>
<details>
    <summary>⚠️ <b>WARN</b> Does GPOS table have kerning information? This check skips monospaced fonts as defined by post.isFixedPitch value <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/opentype.gpos.html#"></a></summary>
    <div>
